...
export function OKXWalletSellerCard() {  
    return (
      <Card size="small" title="okx wallet" style={{ width: 300, margin: 10 }}>
        <Button
          style={{ marginTop: 10 }}
          onClick={async () => {
            ...
            console.log('result: ', result)
             ...
             "23b4595abea49fc83904cdfc02b585a47ce3b76c317103d52810e1abe99f7385i0";
           ...
           console.log("sellerUnsignedPsbtHex===: ", sellerUnsignedPsbtHex);
            ...
            let res = await okxwallet.bitcoin.signPsbt(sellerUnsignedPsbtHex, {
              from: result.address,
            });
            console.log("res: ", res)
            const finalizaedSignedPsbtBase64 = Psbt.fromHex(res).finalizeAllInputs().toBase64()
            console.log("signedSellerPSBTBase64: ", finalizaedSignedPsbtBase64)
          }}
        >
          OKXWallet seller
        </Button>
  ...
  export function OKXWalletBuyerCard() {  
    return (
      <Card size="small" title="okx wallet" style={{ width: 300, margin: 10 }}>
        <Button
          style={{ marginTop: 10 }}
          onClick={async () => {
            ...
            let res = await okxwallet.bitcoin.signPsbt(unsignedBuyingPSBTHex, {
              from: result.address,
            });
            console.log("res: ", res)
            const signedBuyingPSBTBase64 = bitcoin.Psbt.fromHex(res).toBase64();//调merge
